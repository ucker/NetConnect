...
int get_ssl_svg(string& qr_string)
{
    string in_ip, out_ip;
    ...
    string request = "GET /0/wifi/qrcode?1=Android_college_3.2.0&did=862973039766980_89860117834008843883_9cbe255a69e71f49_460015352104293_&vv=3002000&server_did=3abd9ea4-e34f-4c7e-9e9f-25e0c5a833e3&sv=6.0.1_23&mm=Xiaomi+4&imsi=460015352104293&rl=1280*720&pubc=0&brasip=";
    ...
    qr_string = convert_qrcode(qr_information);
    return 0;
}
